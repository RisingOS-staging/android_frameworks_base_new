...
public class AiAssistantGestureListener implements PointerEventListener {
    ...
    private ContentObserver mAiAssistantGestureObserver;
    ...
    private void initInstalledApps() {
        installedAppLabels = new ArrayList<>();
    ...
    private boolean isSwipeDown(MotionEvent event) {
        ...
        return distanceX < 250 && deltaY > 100;
    }
    ...
    private void handleUserCommand(String command) {
        ...
        if (matchesCommand(command, torchCommands)) {
            ...
            speak("Sorry, I can't handle this request yet.");
        }
    }
    ...
    private String extractAppName(String command) {
        ...
        for (String installedApp : installedAppLabels) {
    ...
    private void openChatGPT() {
        ...
        speak("Sure thing! Opening ChatGPT.");
    }
